    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div v-else class="flex flex-col gap-3">
          <div v-for="item in pendingTasks.attendance_pending" :key="item.schedule_id" class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:border-rose-200 dark:hover:border-rose-500/30 transition-all group">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div v-else class="flex flex-col gap-3">
            <div v-for="item in pendingTasks.mark_entry_pending" :key="item.assessment_id" class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:border-amber-200 dark:hover:border-amber-500/30 transition-all group">
               <div class="flex justify-between items-start mb-2">
                  <div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div v-else class="flex flex-col gap-3">
            <div v-for="item in pendingTasks.review_pending" :key="item.submission_id" class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50 hover:border-emerald-200 dark:hover:border-emerald-500/30 transition-all group">
               <div class="flex justify-between items-start mb-2">
                  <div>
