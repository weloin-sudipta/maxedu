  ...
  <aside
    ...
    <div class="flex items-center justify-between px-6 h-20 flex-shrink-0">
      ...
      <button v-show="isExpanded" @click="isCollapsed = !isCollapsed"
        class="p-2 text-gray-400 transition rounded-full hover:bg-indigo-100 hover:text-indigo-600 duration-300">
    ...
    <div v-show="isExpanded"
      class="p-4 border-t border-gray-100 text-[10px] text-gray-400 text-center uppercase tracking-widest font-bold">
