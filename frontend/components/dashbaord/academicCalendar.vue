...
const getTypeStyles = (type) => {
  ...
  if(type==="assignment") return "bg-amber-50 dark:bg-amber-900/20 text-amber-500 dark:text-amber-400"
  if(type==="holiday") return "bg-green-50 dark:bg-green-900/20 text-green-500 dark:text-green-400"
