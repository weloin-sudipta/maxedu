...
export const useStudyMaterials = () => {
  ...
  const updateMaterial = async (name, formData) => {
    ...
    try {
      ...
      const response = await fetch('/api/method/maxedu.api_folder.study_materials.update_study_material', {
        method: 'POST',
        body: fd,
        credentials: 'include',
      })
  ...
  const deleteMaterial = async (name) => {
    ...
    try {
      ...
      const response = await fetch('/api/method/maxedu.api_folder.study_materials.delete_study_material', {
        method: 'POST',
        body: fd,
        credentials: 'include',
      })
