<template>
    <div class="min-h-screen bg-[#f8fafc] p-4 lg:p-8 font-sans text-slate-900">
        <div class="max-w-[1440px] mx-auto">
            ...
            <div v-else class="animate-in">
                ...
                <div class="flex flex-col md:flex-row items-center gap-8">
                    <div class="relative group cursor-pointer" @click="showEditModal = true">
                        ...
                        <div class="absolute inset-0 rounded-[2rem] bg-slate-900/50 dark:bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                            <div class="bg-white dark:bg-slate-800 rounded-xl w-10 h-10 flex items-center justify-center shadow-lg dark:shadow-none transition-colors">
            ...
            <main v-if="activeTab === 'profile'" class="space-y-6 animate-in fade-in duration-500">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200/60 dark:border-slate-800 shadow-sm dark:shadow-none transition-colors">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h3 class="text-lg font-black text-slate-800 dark:text-slate-100 tracking-tight transition-colors">Academic Profile</h3>
                        </div>
                    ...
                    <div
                        class="bg-indigo-600 dark:bg-indigo-700/80 rounded-[2.5rem] p-8 text-white shadow-xl shadow-indigo-100 dark:shadow-none flex flex-col justify-between transition-colors">
                        <div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div v-for="(section, title) in student.secondary" :key="title"
                        ...
                        <h3
                            class="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-8 border-b border-slate-50 dark:border-slate-800/50 pb-4 transition-colors">
                            {{ title }}
                        </h3>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200/60 dark:border-slate-800 shadow-sm dark:shadow-none transition-colors">
                    <h3 class="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-8 transition-colors">Logistics & Residential
                        Details</h3>
            ...
            <div v-else class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-24 border border-dashed border-slate-200 dark:border-slate-800 text-center transition-colors">
                ...
                <h2 class="text-xl font-black text-slate-800 dark:text-slate-100 uppercase tracking-tighter transition-colors">
    ...
    <div v-if="showEditModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <!-- Backdrop -->
        <div class="absolute inset-0 bg-slate-900/60 dark:bg-black/60 backdrop-blur-sm transition-colors" @click="showEditModal = false"></div>

        <!-- Modal -->
        <div
            class="relative bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[2.5rem] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-modal transition-colors">

            <!-- Header -->
            <div class="p-8 border-b border-slate-100 dark:border-slate-800/50 flex justify-between items-center transition-colors">
                <h3 class="text-xl font-black text-slate-800 dark:text-slate-100 transition-colors">Edit Basic Information</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <input type="file" accept="image/*" @change="handleEditPhotoUpload" class="text-slate-700 dark:text-slate-300 transition-colors" />
            ...
            <div class="p-6 border-t border-slate-100 dark:border-slate-800/50 flex justify-end gap-3 transition-colors">
                ...
                <button @click="showEditModal = false"
                    class="px-6 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-black uppercase tracking-widest transition-colors">
                    Cancel
                </button>
