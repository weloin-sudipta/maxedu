...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-rose-500 relative overflow-hidden">
  ...
  <div class="relative z-10 w-full max-w-xl p-10 pb-5">
    ...
    <p class="text-center text-white/60 text-[10px] font-bold uppercase tracking-widest mt-8">
      © 2026 MaxEdu ERP — Empowering Digital Education
    </p>
...
useSeoMeta({
    ...
    description: `Access your MaxEdu ERP account to manage your academic journey. Our secure login portal ensures your data is protected while providing seamless access to your personalized dashboard, course materials, and performance insights.`,
    keywords: 'login, authentication, secure access, user account, MaxEdu ERP'
})
</script>